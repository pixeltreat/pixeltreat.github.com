...
/* Query loader preload page images */
var QueryLoader={overlay:"",loadBar:"",preloader:"",items:new Array(),doneStatus:0,doneNow:0,selectorPreload:"body",ieLoadFixTime:2000,ieTimeout:"",init:function(){if(($.browser.msie)&&($.browser.version.substr(0,1)<7)){return false;}
...
$(QueryLoader.loadBar).animate({height:height+"px",top:0},500,"linear",function(){$(QueryLoader.overlay).fadeOut(800);$(QueryLoader.preloader).remove();});}}

/* CSS Browser Selector v0.3.3 (Sep 09, 2009) Rafael Lima (http://rafael.adm.br) http://rafael.adm.br/css_browser_selector 
